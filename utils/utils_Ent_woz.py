...
def read_langs(file_name, max_line=None, split=False):
    print(("Reading lines from {}".format(file_name)))
    data, context_arr, conv_arr, kb_arr = [], [], [], []
    max_resp_len = 0

    if split:
        entity_file = '../data/MULTIWOZ2.1/global_entities.json'
    else:
        entity_file = 'data/MULTIWOZ2.1/global_entities.json'
        ...
        for line in fin:
            ...
            if line:
                ...
                if '\t' in line:
                    ...
                    r = line
                    if len(r.split()) > 6:    # TODO!  DELETE
                        r = ' '.join(r.split()[-6:])  # TODO!  DELETE
