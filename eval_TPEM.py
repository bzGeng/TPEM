...
from utils import CsvLogger, check_resume_folder, load_or_build_piggymasks, info_reload, load_or_build_masks
...
logger = CsvLogger(file_name='TIPE_middle_results', resume=True, path='results', data_format='csv')
